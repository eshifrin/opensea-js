        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        _a.trys.push([1, 3, , 5]);
                        return [4 /*yield*/, this.makePostRequest("".concat(this.apiBaseUrl, "/wyvern/v1/orders/post/"), order)];
                    case 2:
                        json = _a.sent();
                        return [3 /*break*/, 5];
                    case 3:
                    ...
                    case 5: return [2 /*return*/, json.data];
                }
            });
        });
    };
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        _b.trys.push([1, 3, , 5]);
                        return [4 /*yield*/, this.makeGetRequest("".concat(this.apiBaseUrl).concat(constants_1.API_PATH, "/asset/").concat(tokenAddress, "/").concat(tokenId || 0, "/"))];
                    case 2:
                        json = _b.sent();
                        return [3 /*break*/, 5];
                    case 3:
