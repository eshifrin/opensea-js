...
var OpenSeaAPI = /** @class */ (function () {
     ...
     */
    OpenSeaAPI.prototype.postOrderOld = function (order, retries) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 3:
                        _a.sent();
                        return [2 /*return*/, this.postOrderOld(order, retries - 1)];
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        _a.trys.push([1, 3, , 4]);
                        return [4 /*yield*/, this.makePostRequest("https://api.opensea.io/wyvern/v1/orders/post/", order)];
                    case 2:
                    ...
                    case 3:
                        error_2 = _a.sent();
                        throw error_2;
                    case 4: return [2 /*return*/, json.data];
                }
            });
        });
    };
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 1:
                        _b.trys.push([1, 3, , 5]);
                        return [4 /*yield*/, this.makeGetRequest("https://api.opensea.io".concat(constants_1.API_PATH, "/asset/").concat(tokenAddress, "/").concat(tokenId || 0, "/"))];
                    case 2:
                        json = _b.sent();
                        return [3 /*break*/, 5];
                    case 3:
                    ...
                    case 5: return [2 /*return*/, (0, utils_1.assetFromJSON)(json.data)];
                }
            });
        });
    };
    ...
    OpenSeaAPI.prototype._fetch = function (apiPath, opts) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                ...
                apiKey = typeof this.apiKey === "function" ? this.apiKey() : this.apiKey;
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 4:
                        ...
                        throw new Error("API Error ".concat(response.status, ": ").concat(errorMessage, " | Url: ").concat(response.url));
                }
            });
        });
    };
