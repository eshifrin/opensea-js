...
var OpenSeaPort = /** @class */ (function () {
    ...
    function OpenSeaPort(provider, apiConfig, logger) {
        ...
        var readonlyProvider = new web3_1.default.providers.HttpProvider(this._networkName == types_1.Network.Main
            ? constants_1.MAINNET_PROVIDER_URL
            : constants_1.RINKEBY_PROVIDER_URL);
        // Web3 Config
        this.web3 = new web3_1.default(provider);
        this.web3ReadOnly = new web3_1.default(readonlyProvider);
        // WyvernJS config
    ...
    OpenSeaPort.prototype.getQuoteFromUniswap = function (_a) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_d) {
                switch (_d.label) {
                    case 0:
                        wrappedNFTFactoryContract = new this.web3.eth.Contract(contracts_1.WrappedNFTFactory);
                    ...
                    case 2:
                        ...
                        wrappedNFTContract = new this.web3.eth.Contract(contracts_1.WrappedNFT);
                        return [4 /*yield*/, wrappedNFTContract.at(wrappedNFTAddress)];
                    case 3:
                        wrappedNFT = _d.sent();
                        uniswapFactoryContract = new this.web3.eth.Contract(contracts_1.UniswapFactory);
                    ...
                    case 5:
                        ...
                        uniswapExchangeContract = new this.web3.eth.Contract(contracts_1.UniswapExchange);
            ...
            return __generator(this, function (_e) {
                switch (_e.label) {
                    case 0:
                        ...
                        tokenContract = new this.web3.eth.Contract(tokenAbi);
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        ...
                        cheezeWizardsBasicTournamentABI = new this.web3.eth.Contract(contracts_1.CheezeWizardsBasicTournament);
                    ...
                    case 3:
                        ...
                        decentralandEstateABI = new this.web3.eth.Contract(contracts_1.DecentralandEstates);
