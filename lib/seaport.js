                ...
                switch (_d.label) {
                    ...
                    case 7:
                        ...
                        if (retries <= 0) {
                            throw new Error(
                            // @ts-ignore
                            "Error matching this listing: ".concat(error_11.message, ". Please contact the maker or try again later!"));
                        }
                        return [4 /*yield*/, (0, utils_1.delay)(500)];
                    case 8:
                        _d.sent();
            ...
            return __generator(this, function (_c) {
                switch (_c.label) {
                    ...
                    case 10:
                        ...
                        throw new Error(
                        // @ts-ignore
                        "Oops, the Ethereum network rejected this transaction :( The OpenSea devs have been alerted, but this problem is typically due an item being locked or untransferrable. The exact error was \"".concat(error_13.message.substr(0, debugging_1.MAX_ERROR_LENGTH), "...\""));
                    case 11:
                    ...
                    case 13:
                        ...
                        // @ts-ignore
                        error_14.message ? error_14.message : "user denied", "...\""));
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 6:
                        ...
                        this._dispatch(types_1.EventType.TransactionFailed, __assign(__assign({}, transactionEventData), { 
                            // @ts-ignore
                            error: error_16 }));
                        throw error_16;
                    case 7: return [2 /*return*/];
